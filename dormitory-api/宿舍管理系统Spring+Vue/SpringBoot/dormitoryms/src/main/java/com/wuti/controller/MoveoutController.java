...
import com.wuti.service.MoveoutService;
...
public class MoveoutController {
    ...
    public ResultVO moveout(@PathVariable("id") Integer id,@PathVariable("reason") String season){
        Boolean moveout = this.moveoutService.moveout(id, season);
